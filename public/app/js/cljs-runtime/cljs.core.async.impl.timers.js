...
var i_29495 = (self__.level + (1));
while(true){
if((i_29495 <= (new_level + (1)))){
(update[i_29495] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_29498 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_29498[i]));
} else {
x__$2.forward.push((((i < links_29498.length))?(links_29498[i]):null));
}

if((i < links_29498.length)){
(links_29498[i] = x__$2);
} else {
links_29498.push(x__$2);
}
...
var i_29500 = (0);
while(true){
if((i_29500 <= self__.level)){
var links_29501 = (update[i_29500]).forward;
if((x__$1 === (((i_29500 < links_29501.length))?(links_29501[i_29500]):null))){
(links_29501[i_29500] = (x__$1.forward[i_29500]));

var G__29502 = (i_29500 + (1));
i_29500 = G__29502;
continue;
} else {
var G__29503 = (i_29500 + (1));
i_29500 = G__29503;
continue;
}
} else {
