...
{components:clonedBaseTheme,colorSchemes:baseColorSchemes,prefix,vars:rootVars,spacing:themeProp.spacing?(0,_createSpacing.default)(themeProp.spacing):systemSpacing,breakpoints:themeProp.breakpoints?(0,_createBreakpoints.default)(themeProp.breakpoints):systemBreakpoints,getCssVar:(0,_createGetCssVar.default)(prefix)});const styleSheet={};Object.entries(baseColorSchemes).forEach(([key,scheme])=>{const {css,vars}=(0,_cssVarsParser.default)(scheme,{prefix,basePrefix:designSystemPrefix,shouldSkipGeneratingVar});
...
(0,_jsxRuntime.jsx)(_styledEngine.GlobalStyles,{styles:styleSheet}),(0,_jsxRuntime.jsx)(_ThemeProvider.default,{theme:resolveTheme?resolveTheme(mergedTheme):mergedTheme,children})]})}var _baseTheme$breakpoint;const {theme:baseTheme={},defaultMode:desisgnSystemMode="light",defaultColorScheme:designSystemColorScheme,disableTransitionOnChange=!1,enableColorScheme=!0,prefix:designSystemPrefix="",shouldSkipGeneratingVar,resolveTheme}=options,systemSpacing=(0,_createSpacing.default)(baseTheme.spacing),
systemBreakpoints=(0,_createBreakpoints.default)(null!=(_baseTheme$breakpoint=baseTheme.breakpoints)?_baseTheme$breakpoint:{});(!baseTheme.colorSchemes||"string"===typeof designSystemColorScheme&&!baseTheme.colorSchemes[designSystemColorScheme]||"object"===typeof designSystemColorScheme&&!baseTheme.colorSchemes[null==designSystemColorScheme?void 0:designSystemColorScheme.light]||"object"===typeof designSystemColorScheme&&!baseTheme.colorSchemes[null==designSystemColorScheme?void 0:designSystemColorScheme.dark])&&
console.error(`MUI: \`${designSystemColorScheme}\` does not exist in \`theme.colorSchemes\`.`);const ColorSchemeContext=React.createContext(void 0);CssVarsProvider.propTypes={attribute:_propTypes.default.string,children:_propTypes.default.node,defaultColorScheme:_propTypes.default.oneOfType([_propTypes.default.string,_propTypes.default.object]),defaultMode:_propTypes.default.string,modeStorageKey:_propTypes.default.string,prefix:_propTypes.default.string,theme:_propTypes.default.object};return{CssVarsProvider,
useColorScheme:()=>{const value=React.useContext(ColorSchemeContext);if(!value)throw Error("MUI: `useColorScheme` must be called under \x3cCssVarsProvider /\x3e");return value},getInitColorSchemeScript:_getInitColorSchemeScript.default}};var _extends2=global(require("module$node_modules$$babel$runtime$helpers$extends")),_objectWithoutPropertiesLoose2=global(require("module$node_modules$$babel$runtime$helpers$objectWithoutPropertiesLoose")),_utils=require("module$node_modules$$mui$utils$index"),React=
_interopRequireWildcard(require("module$node_modules$react$index")),_propTypes=global(require("module$node_modules$prop_types$index")),_styledEngine=require("module$node_modules$$mui$styled_engine$node$index"),_createSpacing=global(require("module$node_modules$$mui$system$createTheme$createSpacing")),_createBreakpoints=global(require("module$node_modules$$mui$system$createTheme$createBreakpoints")),_cssVarsParser=global(require("module$node_modules$$mui$system$cssVars$cssVarsParser")),_ThemeProvider=
global(require("module$node_modules$$mui$system$ThemeProvider$index")),_getInitColorSchemeScript=_interopRequireWildcard(require("module$node_modules$$mui$system$cssVars$getInitColorSchemeScript")),_useCurrentColorScheme=global(require("module$node_modules$$mui$system$cssVars$useCurrentColorScheme")),_createGetCssVar=global(require("module$node_modules$$mui$system$cssVars$createGetCssVar")),_jsxRuntime=require("module$node_modules$react$jsx_runtime");const _excluded=["colorSchemes"],_excluded2=["colorSchemes"],
_excluded3=["components"];exports.DISABLE_CSS_TRANSITION="*{-webkit-transition:none!important;-moz-transition:none!important;-o-transition:none!important;-ms-transition:none!important;transition:none!important}"}
